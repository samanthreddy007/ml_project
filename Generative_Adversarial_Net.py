# -*- coding: utf-8 -*-
"""
Created on Tue Apr 30 00:25:35 2019
...
#Data = np.loadtxt("D:/ml_github/cat_data.csv", delimiter=",",skiprows=1)
#Data = np.loadtxt("D:/ml_github/cat_data.csv", delimiter=",",skiprows=1)
#Data = np.loadtxt("D:/Masters/Sem_2/Data_Mining/Letter.csv",delimiter=",",skiprows=1)
dat=pd.read_csv("D:/ml_github/cat_data_full_data.csv")
dat=pd.read_csv("D:/ml_github/cat_data.csv")
